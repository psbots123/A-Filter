...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '') #bot log channel -1002092547529
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '') #support group id ex:  -1002092547529
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://telegram.me/ps_discuss')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://telegram.me/ps_updates')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/+zP6NK2_uwoRlOGQ9')
TUTORIAL = environ.get("TUTORIAL", "https://telegram.me/shareus_open_tutorial/3")
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'http://graph.org/file/cacbbea472e5a48ce0d64.jpg') #telegraph link of your QR code , make from @PS_GraphOrgBot

# for stream
IS_STREAM = is_enabled('IS_STREAM', True) #true if you want stream feature active in your bot
BIN_CHANNEL = environ.get("BIN_CHANNEL", "") #if is_stream = true then add a channel id ex: -1002092547529
